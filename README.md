...
**TMDB API key** - Get a free one at [themoviedb.org](https://www.themoviedb.org/settings/api). Open `CineFlow/Config/APIConfig.swift` and paste your key in `tmdbAPIKey`.
